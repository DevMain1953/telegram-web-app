<template>
  <div class="flex items-center justify-center h-screen bg-gray-100">
    <div class="bg-white p-6 rounded shadow-md w-full max-w-md">
      ...
      <label for="custom_date" class="block mb-2 text-sm font-medium text-gray-700">Введите свою дату рождения:</label>
      ...
      <button @click="submit" class="w-full bg-blue-500 text-white p-2 rounded">Продолжить</button>
    </div>
  </div>
</template>
